...
process.on("message", function(event){
  ...
  case "setConfig":
    if (onlineLines.lines[event.data.line] != null) {
      onlineLines.lines[event.data.line].cache.setConfig = event.data;
    }
  ...
  case "setData":
    if (onlineLines.lines[event.data.line] != null) {
      onlineLines.lines[event.data.line].cache.setData = event.data;
    }
  ...
  case "setTeam":
    onlineLines.teams[event.data.team.teamID] = event.data;
